...
namespace MySchedulerWork.Controllers
{
    public class SubjectsController : Controller
    {
        ...
        public SubjectsController(MyAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Course")] Subject subject)
        {
            if (ModelState.IsValid)
            {
                var element = _context.Subjects.FirstOrDefault(g => g.Name == subject.Name && g.Course == subject.Course);
                if (element != null)
                {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Course")] Subject subject)
        {
            if (id != subject.Id)
            {
                return NotFound();
